...
<div class="lockscreen-wrapper">
  <div class="lockscreen-logo">
    <a href=""><b><?php echo $footer;?></b>POS</a>
  </div>
 ...
 $sql="select * from user where userna_me='$user'";
        ...
        if(mysqli_num_rows($result)>0){
          ...
          if ($query){
           ...
           mysqli_query($conn,"SET session sql_mode = ''");	$sql2 = "insert into user values( '$user','$password','admin','alamat','111','2020-02-02','2020-02-02','admin','dist/upload/index.jpg','')";
    ...
    $pina=sha1(MD5($pin));
       ...
       $sql="select * from pin where pin='$pina'";
        ...
        if(mysqli_num_rows($result)>0){
          ...
          $_SESSION['pin']= $pina;
            echo "<script type='text/javascript'>window.location = 'reset_user?pin=true';</script>";
        } else {
