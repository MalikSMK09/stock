            ...
            <main>
                <div class="row contacts">
                    ...
                    <div class="col invoice-details">
                        <h1 class="invoice-id"><?php echo $judul;?> <?php echo $nomor;?></h1>
...
<?php if($diskon>0){?>
                          <tr>
                            <td colspan="2" ></td>
                            <td colspan="2">PPN <?php echo $perppn;?>%</td>
                            <td> <?php echo number_format($ppn, $decimal, $a_decimal, $thousand).',-';?></td>
                        </tr>
<?php } ?>
<?php if($biaya>0){?>
                        <tr>
                            ...
                            <td colspan="2"><?php echo $bnama;?></td>
