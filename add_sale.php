...
?>
<body OnLoad="document.barcodeform.barang.focus();">
...
function setFocusToTextBox(){
 ...
 <form class="form-horizontal" method="get" name="barcodeform" id="formmain" class="form-user">
           ...
           <div class="col-sm-9 col-sm-10 col-lg-9 col-xs-12">
            <input type="text" class="form-control"  placeholder="Ketikan Nama Barang" id="barang" name="barang">
...
barcode.addEventListener("keypress", function(event) {
  ...
  <div class="row">
    ...
    <a href="penjualan.php" class="btn btn-block btn-danger">Kembali</a>
            </div>

             <div class="col-xs-12 col-md-6 col-lg-6">
    <a href="bayar_inv.php" class="btn btn-block btn-primary">F9 | Lanjut Bayar</a>
            </div>
