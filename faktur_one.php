      ...
      <div class="col-xs-12">
        <p></p>
          ...
          <table class="table">
            <tr>
                <th>Sub Total:</th>
                <td style="width: 100%">Rp. <?php echo number_format(($pot+$total-$biaya), $decimal, $a_decimal, $thousand).',-';?></td>
              </tr>
    <?php if($diskon>0){?>          
               <tr>
...
<?php } ?>
    ...
    <?php if($perppn>0){?>          
               <tr>
                <th>PPN(<?php echo $perppn;?>)%:</th>
                <td>Rp. <?php echo number_format($ppn, $decimal, $a_decimal, $thousand).',-';?></td>
              </tr>
<?php } ?>
