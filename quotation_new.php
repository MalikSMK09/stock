       ...
       if($_SERVER["REQUEST_METHOD"] == "POST"){
            ...
            if($pelanggan != ''){ 
              ...
              $kasir = $_SESSION["username"];
                 ...
                 $sql="select * from quotation where nota='$kode'";
            $result=mysqli_query($conn,$sql);

                  if(mysqli_num_rows($result)>0){

                    echo "<script type='text/javascript'>  alert('Data penawaran dengan kode transaksi yang sama sudah ada!');</script>";
              }
          else if(( $chmod >= 2 || $_SESSION['jabatan'] == 'admin')){

               mysqli_query($conn,"SET session sql_mode = ''");	$sql2 = "insert into quotation values( '$nota','$nomor','$tglnota','$duedate','$pelanggan','$databelitotal','$total','$diskon','$pot','$biaya','aktif','$kasir','','$keterangan','')";
               $insertan = mysqli_query($conn, $sql2);

               echo "<script type='text/javascript'>  alert('Berhasil, Penawaran telah dibuat!'); </script>";
            ...
            echo "<script type='text/javascript'>  alert('GAGAL, Pelanggan belum dipilih!'); </script>";
...
<div class="box-body no-padding">
     <?php
           ...
           $sql    = "select * from quotation_list where nota ='$nota' order by no";
           $result = mysqli_query($conn, $sql);
           $rpp    = 15;
...
<form  method="post" id="Myform" class="form-user">
 ...
 <input type="hidden" class="form-control" id="tot" value="<?php echo $datatotal;?>" >
                ...
                <tr>
                  ...
                  <td><input type="text" class="form-control" value="<?php echo $nota;?>" name="nomor"></td>
                ...
                <tr>
                 ...
                 <tr>
                  ...
                  <td > <a class="btn btn-block pull-left btn-flat btn-danger"  href="add_quotation">KEMBALI</a> </td>
                  <td ><button type="submit" class="btn btn-block pull-left btn-flat btn-success" name="simpan" onclick=" document.getElementById('Myform').submit();" >BUAT PENAWARAN</button></td>
