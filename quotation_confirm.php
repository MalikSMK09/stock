...
$halaman = "quotation_confirm"; // halaman
       ...
       if($_SERVER["REQUEST_METHOD"] == "POST"){
        ...
        if (SecurityBootstrap::execute($conn, "UPDATE quotation_list SET conv = '0' WHERE nota = ?", 's', [$quo]) !== false) {
               ...
               echo "<script type='text/javascript'>  alert('GAGAL, terjadi kesalahan!'); </script>";
                  echo "<script type='text/javascript'>window.location = '$forwardpage?q=$q';</script>";
        }
...
if ($chmod >= 2 || $_SESSION['jabatan'] == 'admin') {
  ...
  <!-- KONTEN BODY AWAL -->
             ...
             <div class="alert alert-danger alert-dismissible">
                ...
                Kami menemukan proses konversi penawaran sebelumnya yang belum selesai. Anda tidak bisa melakukan konversi sebelum proses sebelumnya selesai atau dibatalkan. Pilih salah satu opsi dibawah
              </div>
                             ...
                             <a href="quotation_conv?q=<?php echo $q;?>" class="btn btn-info">Lanjutkan Konversi Sebelumnya</a>
                              <a href="quotation" class="btn btn-warning">KEMBALI</a>
                          </form>
