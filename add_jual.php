 ...
 <form class="form-horizontal" method="get" name="barcodeform" id="formmain" class="form-user">
         ...
         <div class="col-sm-2 col-lg-2 col-xs-12">
          ...
          <div class="col-sm-2 col-lg-2 col-xs-12">
           ...
           <div class="col-sm-2 col-lg-2 col-xs-12">
            <input type="text" class="form-control"  placeholder="jumlah dijual" name="qty" id="qty" value="1">
  ...
  <div class="row">
        <div class="col-xs-12">
            <button type="button" name="addcart1" id="addcart1" class="btn btn-success btn-block">ENTER | Masukan Keranjang</button>
               <button type="button" name="scanbarcode" id="scanbarcode" class="btn btn-default btn-block" >Scan</button>
        </div>
</div>
...
barcode.addEventListener("keypress", function(event) {
  ...
  <div class="row">
    ...
    <a href="retur.php" class="btn btn-block btn-danger">Kembali</a>
             ...
             <div class="col-xs-12 col-md-6 col-lg-6">
    <a href="bayar.php" class="btn btn-block btn-primary">F9 | Lanjut Bayar</a>
            </div>
