   ...
   if($_SERVER["REQUEST_METHOD"] == "POST"){
        ...
        $result=mysqli_query($conn,$sql);
          ...
          if($chmod >= 3 || $_SESSION['jabatan'] == 'admin'){
           ...
           mysqli_query($conn,"SET session sql_mode = ''");	$sql2 = "insert into $tabeldatabase values( '$kode','$bank','$norek','$nama','')";
...
?>
               ...
               <h3 class="box-title">Data <?php echo $forward ?>  </span>
               </h3>
               ...
               <?php  if ($chmod >= 4 || $_SESSION['jabatan'] == 'admin') { ?>
                <?php  if ( $fill['nama'] != 'admin') { ?>
                 <button type="button" class="btn btn-danger btn-xs" onclick="window.location.href='component/delete/delete_master?no=<?php echo $fill['no'].'&'; ?>forward=<?php echo "rekening".'&';?>forwardpage=<?php echo 'rekening'.'&'; ?>chmod=<?php echo $chmod; ?>'">Hapus</button>
               <?php } } else {}?>
               </td></tr>
               <?php
               $i++;
