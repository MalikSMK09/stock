...
// masukan mutasi
               mysqli_query($conn,"SET session sql_mode = ''");	$sql4 = "INSERT INTO mutasi values ( '$kasir','$today','$jam','$kode','$sisaakhir','$terima','$kegiatan','$nota','','$status')";
