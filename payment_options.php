...
mysqli_query($conn,"SET session sql_mode = ''");	$sql2 = "insert into $tabeldatabase values( '$nama','pay','')";
...
mysqli_query($conn,"SET session sql_mode = ''");	$sql2 = "insert into $tabeldatabase values( '$nama','bank','')";
               $insertan = mysqli_query($conn, $sql2);
