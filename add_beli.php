...
$insert = $_POST['insert'];
 ...
 function autoNumber(){
  ...
  global $forward;
  $query = "SELECT MAX(RIGHT(nota, 4)) as max_id FROM beli ORDER BY nota";
  ...
  <!-- KONTEN BODY AWAL -->
    ...
    if(isset($_POST["tambah"])){
       if($_SERVER["REQUEST_METHOD"] == "POST"){
              ...
              $kegiatan = "membeli barang tanpa invoice";
              $status = "pending";
              $insert = ($_POST["insert"]);
    ...
    if(isset($_POST["simpan"])){
       if($_SERVER["REQUEST_METHOD"] == "POST"){
            ...
            $result=mysqli_query($conn,$sql);
               ...
               mysqli_query($conn,"SET session sql_mode = ''");	$sql2 = "insert into beli values( '$kode','$tglnota','$datatotal','$supplier','$kasir','$keterangan','')";
               $insertan = mysqli_query($conn, $sql2);
          ...
          <form class="form-horizontal" method="post" action="add_<?php echo $halaman; ?>" id="Myform" class="form-user">
              <div class="box-body">
                ...
                <div class="row">
                  ...
                  <div class="form-group col-md-6 col-xs-12" >
                  <label for="tglnota" class="col-sm-4 control-label">Tgl Jatuh Tempo:</label>
                  <div class="col-sm-8">
