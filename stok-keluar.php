   ...
   <!-- right column -->
        <div class="col-md-6" >
          ...
          <div class="box box-info">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form class="form-horizontal" name="barcodeform" method="post" action="stok-keluar">
              <div class="box-body">
...
echo "<script type='text/javascript'>  alert('Gagal, Jumlah Barang tidak boleh kosong');</script>";
                      ...
                      //merekam mutasi
               mysqli_query($conn,"SET session sql_mode = ''");	$sql4 = "INSERT INTO mutasi values ( '$kasir','$today','$kode','$sisa','$jumlah','$kegiatan','$nota','','$status')";
