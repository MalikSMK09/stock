...
if($stok!=$tersedia){
            ...
            $resulte=mysqli_query($conn,$sql);
                ...
                mysqli_query($conn,"SET session sql_mode = ''");	  $q="INSERT INTO stok_sesuai_daftar VALUES('$nota','$kode','$nama','$stok','$tersedia','$selisih','$ket','')";

                  if(mysqli_query($conn,$q)){


                    $b=mysqli_query($conn,"UPDATE barang SET sisa='$tersedia' WHERE kode='$kode'");
                mysqli_query($conn,"SET session sql_mode = ''");	    $a=mysqli_query($conn,"INSERT INTO mutasi VALUES('$usr','$tgl','$kode','$tersedia','$selisih','$kegiatan','$nota','','pending')");
...
mysqli_query($conn,"SET session sql_mode = ''");	
               mysqli_query($conn,"SET session sql_mode = ''");	   $q="INSERT INTO stok_sesuai VALUES('$nota','$date','$usr','$ket','')";
