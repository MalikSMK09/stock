...
if (count($pesanError)>=1 ){
      ...
      <input type="hidden" name="hapusberhasil" value="3" />
               ...
               mysqli_query($conn,"SET session sql_mode = ''");	$sql2 = "insert into $tabeldatabase values( '$username','$password','$nama','$alamat','$nohp','$tgllahir','$tglaktif','$jabatan','$avatar','')";
