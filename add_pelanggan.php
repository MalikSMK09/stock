...
if ($chmod >= 2 || $_SESSION['jabatan'] == 'admin') {
   ...
   <div class="container-fluid">
        ...
        <div class="row">
                <div class="form-group col-md-6 col-xs-12" >
                  <label for="kode" class="col-sm-3 control-label">ID Pelanggan:</label>
                  <div class="col-sm-9">
                   <?php  if($no == null || $no ==""){ ?>
                    <input type="hidden" class="form-control" id="kode" name="kode" value="<?php echo autoNumber(); ?>" maxlength="50" required readonly>
                     <input type="text" class="form-control" id="idpelanggan" name="idpelanggan" value="<?php echo autoNumber(); ?>" maxlength="50" required>
                  <?php }else{ ?>
             <input type="hidden" class="form-control" id="kode" name="kode" value="<?php echo $kode; ?>"  maxlength="50" required readonly>
             <input type="text" class="form-control" id="idpelanggan" name="idpelanggan" value="<?php echo $id; ?>"  maxlength="50" required readonly>
          <?php } ?>
          </div>
                </div>
        </div>
        ...
        <div class="row">
           <div class="form-group col-md-6 col-xs-12" >
                  <label for="tgldaftar" class="col-sm-3 control-label">Tanggal Terdaftar</label>
                  <div class="col-sm-9">
                    <input type="text" class="form-control pull-right" id="datepicker2" name="tgldaftar"  value="<?php echo $tgldaftar; ?>" >
                  </div>
                </div>
        </div>
 ...
 <?php
    ...
    ?>
        ...
        <div class="row">
           <div class="form-group col-md-6 col-xs-12" >
                  <label for="alamat" class="col-sm-3 control-label">Status:</label>
                   <div class="col-sm-9">
                <div class="radio">
                    <label>
                      <input type="radio" name="status" id="optionsRadios1" value="pelanggan" checked>
                     Berlangganan
                    </label>
                  </div>
                  <div class="radio">
                    <label>
                      <input type="radio" name="status" id="optionsRadios2" value="prospek">
                      Calon Pelanggan
                    </label>
                  </div>
      ...
      <input type="hidden" class="form-control" id="insert" name="insert" value="<?php echo $insert;?>" maxlength="1" >
              ...
              <div class="box-footer" >
                 ...
                 <a href="pelanggan.php" class="btn btn-warning btn-flat">Kembali</a>
   ...
   if($_SERVER["REQUEST_METHOD"] == "POST"){
        ...
        $result=mysqli_query($conn,$sql);
          ...
          if($chmod >= 3 || $_SESSION['jabatan'] == 'admin'){
                  $sql1 = "update $tabeldatabase set nama='$nama',nohp='$nohp',alamat='$alamat',email='$email',status='$status' where kode='$kode'";
          ...
          echo "<script type='text/javascript'>window.location = '$forwardpage';</script>";
           ...
           mysqli_query($conn,"SET session sql_mode = ''");	$sql2 = "insert into $tabeldatabase values( '$kode','$tgldaftar','$nama','$alamat','$nohp','$email','$id','$status','')";
