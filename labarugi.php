...
$sqlx="SELECT SUM(total) AS retail, SUM(pajak) as tax1 FROM bayar WHERE tglbayar BETWEEN '" . $dari . "' AND  '" . $sampai . "' ";
...
$sqlx1="SELECT SUM(total-sudahbayar) AS unpaid FROM sale WHERE tglsale BETWEEN '" . $dari . "' AND  '" . $sampai . "' ";
...
$pemasukan= $retail + $totalsales + 0 -$tax;
...
<table>
 ...
 <tr>
  ...
  <tr>
   <td style="text-align:center;width:200px;height:20px;">Beban Penjualan</td>
    <td style="width:700px;height:20px;">Pajak Penjualan</td>
    <td  style="text-align:center;width:200px;height:20px;"><?php echo number_format($tax);?></td>
