    ...
    $checkbox = '1';
           ...
           $sql1 = "update backset set url='$url', sessiontime='$session', footer='$footer', responsive='$checkbox'";
             ...
             echo "<script type='text/javascript'>window.location = 'set_general';</script>";
                ...
                mysqli_query($conn,"SET session sql_mode = ''");	$sql1 = "insert into backset (url,sessiontime,footer,responsive) values('$url','$session','$footer','$checkbox')";
              $result = mysqli_query($conn, $sql1);
              echo "<script type='text/javascript'>  alert('Berhasil, Data telah disimpan!'); </script>";
              echo "<script type='text/javascript'>window.location = 'set_general';</script>";
        }
            ...
            <?php }?>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-10">
                 ...
                 <div class="form-group">
                  <label for="session" class="col-sm-2 control-label">Pajak (PPN)</label>
                  <div class="col-sm-10">
                    <input type="text" class="form-control" id="ppn" name="ppn" value="<?php echo $ppn; ?>" maxlength="2">
                  </div>
                </div>
...
$sql="select * from data";
 ...
 if((($tipeavatar == "image/jpeg" || $tipeavatar == "image/png") && ($ukuranavatar <= 10000000)) && ($chmod >= 3 || $_SESSION['jabatan'] == 'admin')){
         ...
         $sql1 = "update data set nama='$nama', alamat='$alamat', notelp='$notelp', tagline='$tagline', signature='$signature', avatar='$avatar', pajakppn='$ppn'";
 ...
 echo "<script type='text/javascript'>  alert('Gagal!');</script>";
  ...
  move_uploaded_file($tmp, $avatar);
  mysqli_query($conn,"SET session sql_mode = ''");	$sql2 = "insert into data (nama, alamat, notelp, tagline, signature) values('$nama','$alamat','$notelp','$tagline','$signature','$avatar')";
