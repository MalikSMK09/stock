...
$no=$_GET['no'];
 ...
 ?>
         ...
         <div class="form-group">
                  <label for="menu2" class="col-sm-3 control-label">Modul Kasir</label>
                  <div class="col-sm-9">
         ...
         <div class="form-group">
                  <label for="menu3" class="col-sm-3 control-label">Modul Pelanggan & Penawaran</label>
                  <div class="col-sm-9">
         ...
         <div class="form-group">
                  <label for="menu4" class="col-sm-3 control-label">Modul Barang</label>
                  <div class="col-sm-9">
         ...
         <div class="form-group">
                  <label for="menu5" class="col-sm-3 control-label">Modul Pembelian</label>
                  <div class="col-sm-9">
                 ...
                 <div class="form-group">
                  <label for="menu5" class="col-sm-3 control-label">Modul Invoice</label>
                  <div class="col-sm-9">
                ...
                <div class="form-group">
                  <label for="menu5" class="col-sm-3 control-label">Modul Pengeluaran</label>
                  <div class="col-sm-9">
                ...
                <div class="form-group">
                  <label for="menu8" class="col-sm-3 control-label">Modul Stok</label>
                  <div class="col-sm-9">
                ...
                <div class="form-group">
                  <label for="menu5" class="col-sm-3 control-label">Modul Laporan</label>
                  <div class="col-sm-9">
                ...
                <div class="form-group">
                      <label for="menu10" class="col-sm-3 control-label">Modul Pengaturan</label>
                <div class="col-sm-9">
  ...
  $menu11 = $_POST['menu11'];
        ...
        if(isset($_POST['simpan'])){
           ...
           if(mysqli_query($conn, $sql1)){
              ...
              echo "<script type='text/javascript'>  alert('Berhasil, Hak Akses berhasil diupdate!');</script>";

                } else {
                     echo "<script type='text/javascript'>  alert('Gagal, Jabatan tidak ada didatabase!');</script>";
                }
             
        }else{
                mysqli_query($conn,"SET session sql_mode = ''");	$sql1 = "insert into chmenu values('$userjabatan','$menu1','$menu2','$menu3','$menu4','$menu5','$menu6','$menu7','$menu8','$menu9','$menu10','$menu11')";
             if(mysqli_query($conn, $sql1)){
               echo "<script type='text/javascript'>window.location = 'add_jabatan';</script>"; 
                echo "<script type='text/javascript'>  alert('Hak Akses telah berhasil diatur');</script>";

              } else {
                 echo "<script type='text/javascript'>  alert('Gagal memasukan data ke database!');</script>";
              }
